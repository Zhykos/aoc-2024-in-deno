...
export function day17part2(): number {
  ...
  let program: string[] = [];
  //let resultRegisterA = 191488122;
  //let resultRegisterA = 191495153709;
  //let resultRegisterA = 492046684176;
  //let resultRegisterA = 499046684176; --- 1
  //let resultRegisterA = 599046684176; --- 2
  let resultRegisterA = 699046684176;
  let originalRegisterB = 0;
  let originalRegisterC = 0;
  ...
  for (const line of inputRaw.split("\n")) {
    ...
    if (line.startsWith("Register A:")) {
      ...
      originalRegisterB = Number.parseInt(line.split(" ")[2]);
    } else if (line.startsWith("Register C:")) {
      originalRegisterC = Number.parseInt(line.split(" ")[2]);
  ...
  while (result !== program.join(",")) {
    console.log("resultRegisterA", resultRegisterA);
    registerA = resultRegisterA++;
    ...
    result = output.filter((o) => o.length > 0).join(",");
    console.log(output.filter((o) => o.length > 0).length, result);
  }

  return resultRegisterA - 1;
}
